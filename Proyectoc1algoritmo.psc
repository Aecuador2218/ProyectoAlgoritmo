...
Funcion Presentar_cantidad_de_digitos_de_todos_los_numeros_de_una_secuencia_de_numeros_hasta_0()
Definir n,cont,a,contador Como Entero
Repetir
	cont=cont+1
...
Funcion puntoscomas()
	...
	Definir puntos,comas,puntosycomas,dospuntos Como Entero
...
funcion Indicar_cuantas_palabras_hay_en_una_frase_asumiendo_1_varios_espacios_entre_palabras_7()
Definir f Como Caracter
Definir h,j,a Como Entero
Escribir "Ingrese la frase"
Leer f
f=f+" "
h=longitud(f)
Mientras j<h Hacer
	Si (Subcadena(f,j,j)=" ") Entonces
		Si (Subcadena(f,j-1,j-1)<>" ") Entonces
			a=a+1
		FinSi
	FinSi
	j=j+1
FinMientras
Escribir "En esta frase hay ",a," palabras"
FinFuncion
...
funcion Dado_una_serie_de_numeros_guardar_en_un_arreglo_solo_los_numeros_negativos()
	...
	Finpara
Finfuncion
//Dado un arreglo de nombres presentar el primer caracter de cada nombre 4 arreglos
funcion Dado_un_arreglo_de_nombres_presentar_el_primer_caracter_de_cada_nombre()
Definir b Como Caracter
...
Mientras n<d Hacer
	...
	n=n+1
Fin Mientras
Escribir "Las Iniciales de los nombres  son:  " 
Mientras l<d Hacer		
	Escribir SubCadena(b[l],0,0) Sin Saltar
	l=l+1
Fin Mientras
finfuncion
//Dado un arreglo de numeros presentar el total, la cantidad y el promedio del arreglo 5
funcion Dado_un_arreglo_de_numeros_presentar_el_totalla_cantidad_y_el_promedio_del_arreglo()
	Definir n Como Caracter
	Definir d,l,cont,suma,p Como Entero
				...
				Mientras opcn <> "11" Hacer         
					...
					Segun opcn Hacer
						...
						"5":
				            ...
				            Presentar_cantidad_de_digitos_de_todos_los_numeros_de_una_secuencia_de_numeros_hasta_0()
							esperar 3 Segundos
						"6":
				...
				mientras opcn <> "11" Hacer
					...
					segun opcn hacer
						...
						"7":
							...
							Indicar_cuantas_palabras_hay_en_una_frase_asumiendo_1_varios_espacios_entre_palabras_7()
							esperar 3 segundos
						"8":
				...
				mientras opcn <> "11" Hacer
					...
					segun opcn hacer
						...
						"4":
							...
							Dado_un_arreglo_de_nombres_presentar_el_primer_caracter_de_cada_nombre()
							Esperar 3 Segundos
						"5":
							Escribir "Dado un arreglo de numeros presentar el total, la cantidad y el promedio del arreglo"
							Dado_un_arreglo_de_numeros_presentar_el_totalla_cantidad_y_el_promedio_del_arreglo()
							esperar 3 Segundos
						"6":
